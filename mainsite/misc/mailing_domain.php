...
$es_subjhtml = "Ya puedes usar tu propio dominio en Yourpacs!";
$es_bodyhtml = "
<h1>Ya puedes usar tu propio dominio en Yourpacs!</h1>
<p>
Desde ahora mismo, en Yourpacs te ofrecemos la posibilidad de poder usar tu
propio dominio, sin ningún coste! Si ya tienes un dominio, únicamente tendrás que
redireccionarlo al dominio ofrecido por Yourpacs, e introducirlo en tu panel
...
<ul>
    ...
    <li>Ya dispones del <a href=\"http://blog.lynksee.com\">Blog oficial de Yourpacs</a>.</li>
</ul>
...
$ca_subjhtml = "Ja pots usar el teu propi domini a Yourpacs!";
$ca_bodyhtml = "
<h1>Ja pots usar el teu propi domini a Yourpacs!</h1>
<p>
Des d'ara mateix, a Yourpacs t'oferim la possibilitat de poder usar teu
propi domini, sense cap cost! Si ja tens un domini, únicament hauràs que
redireccionar-lo al domini ofert per Yourpacs, i introduir-lo al teu panell
...
<ul>
	...
	<li>Ja disposes del <a href=\"http://blog.lynksee.com\">Blog oficial de Yourpacs</a>.</li>
</ul>
...
$en_subjhtml = "Now, you can use your own domain in Yourpacs!";
$en_bodyhtml ="
<h1>Now, you can use your own domain in Yourpacs!</h1>
<p>
Since right now, in Yourpacs we offer you the possibility to be able to use yours
own domain, without any cost! If you already have a domain, only have that
redirect it to the domain offered by Yourpacs, and introduce it into your control panel. Since that moment, all your pages will use your own domain without waiting, without high and without quotas, etc.
<br/><br/>
...
<ul>
	...
	<li>You can visit the <a href=\"http://blog.lynksee.com\">Yourpacs Blog</a>.</li>
</ul>
...
<br/><br/>
We thank you for use Yourpacs, and we expect that you like all these novelties .<br/>
